            ...
            <div class="container">
                 <ul class="nav navbar-nav">
                     <li class="nav-item active">
                         <a class="nav-link" href="/pages/{{ $page->id }}/b">{{ $page->descriptor }}</a>
                     </li>
                 </ul>
        ...
        <section class="main-content">
            <div class="container-fluid bg-image box-shadow">
                <nav class="hidden-md-up text-sm-center text-xs-center">
                    <p class="lead">
                        <br>
                        <a class="nav-link text-white" href="/pages/{{ $page->id }}/b">{{ $page->descriptor }}</a>
                        <br>
                        <a class="text-white" href="callto:{{ $page->phone }}">{{ $page->phone }}</a>
                    </p>
                </nav>
                <br>
                <br>
