        ...
        <footer>
            ...
            <div class="container-fluid bg-faded text-muted">
                <div class="container py-1">
                    {{ $page->legal }} Телефон: <a href="callto:{{ $page->phone }}">{{ $page->phone }}</a>. Email: <a href="mailto:{{ $page->email }}">{{ $page->email }}</a>. Дата обновления сайта: {{ date_format($page->updated_at, 'd.m.Y') }}. Сайт разработан <a href="http://genlid.com">genlid.com</a>.
                </div>
            </div>
        </footer>
