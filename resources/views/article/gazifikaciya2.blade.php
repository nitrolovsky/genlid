...
@component("components.bgimage")
    ...
    @endslot
    @slot("image")
        "/images/gazifikaciya2/gazifikaciya-fotografiya-1.jpg"
    @endslot
    @slot("caption")
...
<div class="container pb-5">
    ...
    <div class="row">
        <div class="col-xl-3">
            <img src="/images/gazifikaciya2/primer-1.jpg" class="img-fluid mx-auto d-block">
        </div>
        <div class="col-xl-9">
            <h4 class="russo">
    ...
    <div class="row">
        <div class="col-xl-3">
            <img src="/images/gazifikaciya2/primer-2.jpg" class="img-fluid mx-auto d-block">
        </div>
        <div class="col-xl-9">
            <h4 class="russo">
    ...
    <div class="row">
        <div class="col-xl-3">
            <img src="/images/gazifikaciya2/primer-3.jpg" class="img-fluid mx-auto d-block">
        </div>
        <div class="col-xl-9">
            <h4 class="russo">
    ...
    <div class="row">
        <div class="col-xl-3">
            <img src="/images/gazifikaciya2/primer-4.jpg" class="img-fluid mx-auto d-block">
        </div>
        <div class="col-xl-9">
            <h4 class="russo">
...
<div class="container pb-5">
    <div class="row">
        <div class="col-xl-12">
            <h2 class="h1 russo text-center py-5">
    ...
    <div class="row">
        <div class="col-xl-3">
            <img src="/images/gazifikaciya2/tehnika-1.jpg" class="img-fluid mx-auto d-block">
            <h6 class="russo py-3">
                Экскаватор-погрузчик для общестроительных работ.
            </h6>
        </div>
        <div class="col-xl-3">
            <img src="/images/gazifikaciya2/tehnika-2.jpg" class="img-fluid mx-auto d-block">
            <h6 class="russo py-3">
                Установка горизонтального бурения для прокладки газопровода без траншеи
            </h6>
        </div>
        <div class="col-xl-3">
            <img src="/images/gazifikaciya2/tehnika-3.jpg" class="img-fluid mx-auto d-block">
            <h6 class="russo py-3">
                Самоходный бетоносмесительный узел для изготовления бетона в недоступных местах
            </h6>
        </div>
        <div class="col-xl-3">
            <img src="/images/gazifikaciya2/tehnika-4.jpg" class="img-fluid mx-auto d-block">
            <h6 class="russo py-3">
        ...
        <div class="row">
            <form class="col-xl-10 offset-xl-1">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control col-xl-4" id="formGroupExampleInput" placeholder="1" value="1">
                </div>
                <br>
                ...
                <div class="row">
                    <div class="col-xl-4">
                        ...
                        <button type="submit" class="btn btn-primary btn-block" onclick="yaCounter42033909.reachGoal('OrderByPhone'); return true;"><span class="fa fa-fw fa-calculator" aria-hidden="true"></span>&nbsp;Получить расчет</button>
                    </div>
                </div>
                <br>
            </form>
