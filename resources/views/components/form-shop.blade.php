            ...
            <div class="col-xl-6 col-lg-6 col-md-8 col-sm-12 col-xs-12 offset-xl-3 offset-lg-3 offset-md-2">
                <div class="mb-0">
                    ...
                    <form action="/orders" method="POST">
                        ...
                        <div class="form-group {{ !empty($errors->orders->first('name')) ? 'has-danger' : ''}} {{ !empty(old('name')) ? 'has-success' : ''}}">
                            <input type="text" class="form-control btn-circle {{ !empty($errors->orders->first('name')) ? 'form-control-danger' : ''}} {{ !empty(old('name')) ? 'form-control-success' : ''}}" id="phone" placeholder="ФИО" name="name" value="{{ old('name') }}">
                        </div>
                        ...
                        <div class="form-group {{ !empty($errors->orders->first('address')) ? 'has-danger' : ''}} {{ !empty(old('address')) ? 'has-success' : ''}}">
                            <input type="text" class="form-control btn-circle {{ !empty($errors->orders->first('address')) ? 'form-control-danger' : ''}} {{ !empty(old('address')) ? 'form-control-success' : ''}}" id="phone" placeholder="Адрес доставки" name="address" value="{{ old('address') }}">
                        </div>
