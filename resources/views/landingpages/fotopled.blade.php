            ...
            <div class="container pt-5">
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-xs-12 offset-xl-2 offset-lg-2">
                        ...
                        <ul class="h5 russo">
                            <li class="pb-1">Доставляем по всей Россиии с 2009 года</li>
            ...
            <div class="container pb-5">
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-xs-12 offset-xl-2 offset-lg-2">
                        ...
                        <div class="pt-3">
                            Плед с любой фотографией: любимого героя, близких людей, коллаж из фотографий. Плед с любым рисунком: ребенка, любимая иллюстрация, картина. Плед с любым принтом для дизайнеров и декораторов возможность печати любых работ. Плед с корпоративным дизайном. Пледы для тех, кто хочет продавать свою марку и уникальную продукцию.
                        </div>
