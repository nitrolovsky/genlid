                        ...
                        <div class="container">
                            ...
                            <form action="/leads/detoxya" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="">
                                        <button type="submit" class="sw btn-circle btn btn-primary btn-block" onclick="yaCounter43848769.reachGoal('zakaz'); return true;" role="button">Получить бесплатно</button>
                                    </div>
                                </div>
                            </form>
        ...
        <script type="text/javascript">
            (function (d, w, c) {
                (w[c] = w[c] || []).push(function() {
                    try {
                        w.yaCounter43848769 = new Ya.Metrika({
                            id:43848769,
                            clickmap:true,
                            trackLinks:true,
