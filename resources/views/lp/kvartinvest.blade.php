...
<html>
    <head>
        ...
        <title>
            Инвестирование в недвижимость СПб по уму
        </title>
        <style>
            .bg-img {
                background: url("/files/kvartinvest/bg.jpg") no-repeat top center;
    ...
    <body>
                ...
                <div class="container font">
                    <div class="row pt-4">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 text-xl-left text-lg-left text-md-left text-sm-center text-center">
                            ...
                            <span class="descriptor">Инвестирование в недвижимость СПб по уму</span>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 text-xl-right text-lg-right text-md-right text-sm-center text-center">
                            ...
                            <a href="tel:88126424265" class="a text-info">8 (812) 642 42 65</a><br>
                            Санкт-Петербург<br> Каменноостровский проспект дом 26-28<br>Дом Бенуа
                        </div>
                    </div>
                    <div class="row pt-5">
                        <div class="col-xl-10 col-lg-12 col-md-12 col-sm-12 col-12 offset-xl-1">
                            <h1 class="text-center my-0 weight-700">
                                21 апреля 2017 в 19:15 - Семинар "Как купить себе квартиру уже в 2017 году" или заработать на недвижимости
                            </h1>
                        </div>
                    </div>
                    <div class="row pt-5">
                        <div class="col-xl-10 col-lg-12 col-md-12 col-sm-12 col-12 offset-xl-1">
                            <div class="my-0 text-center">
                                <p class="font bullets">
                                    Разбор конкретных примеров за 2015 и 2016 год с доходностью 58%.<br>
                                    Анонсы новых объектов и бронирование на старте продаж.<br>
                                    Как обойти уловки менеджеров отдела продаж застройщика и купить то, что Вам реально нужно.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="row pt-5">
                        <div class="col-xl-8 col-lg-8">
                            <div class="embed-responsive embed-responsive-16by9 sw" id="video">
                                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/M32KCq5_X6Q?rel=0&showinfo=0" allowfullscreen></iframe>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-6 offset-xl-0 offset-lg-0 offset-md-3">
                            ...
                            <form action="/leads/beautykitchen" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="">
                                        <button type="submit" class="font sw btn-circle btn btn-primary btn-block" role="button">Зарегистрироваться бесплатно</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <script type="text/javascript">
            (function (d, w, c) {
                (w[c] = w[c] || []).push(function() {
                    try {
                        w.yaCounter44019904 = new Ya.Metrika({
                            id:44019904,
                            clickmap:true,
                            trackLinks:true,
        ...
        <noscript><div><img src="https://mc.yandex.ru/watch/44019904" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
        <!-- /Yandex.Metrika counter -->
    </body>
</html>
