...
<html>
    <head>
        ...
        })(window,document,'script','dataLayer','GTM-KVD5HQT');</script>
    ...
    <body>
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KVD5HQT"
                ...
                <div class="container font">
                    <div class="row pt-4">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 text-xl-left text-lg-left text-md-left text-sm-center text-center">
                            ...
                            <span class="descriptor">Оптовые поставки кроссовок из Китая</span>
                        </div>
                        ...
                        <div class="col-xl-10 col-lg-12 col-md-12 col-sm-12 col-12 offset-xl-1">
                            <div class="my-0 text-center">
                                <p class="font bullets">
                                    ADIDAS, REEBOK, ASICS, PUMA, NIKE, NEW BALANCE.<br>
                                    Минимальная партия от 20 пар.<br>
                    ...
                    <div class="row pt-5">
                        <div class="col-xl-8 col-lg-8">
                            <div class="embed-responsive embed-responsive-16by9 sw" id="video">
                                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/Vt0RVmQgrTE?rel=0&showinfo=0" allowfullscreen></iframe>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            (function (d, w, c) {
                (w[c] = w[c] || []).push(function() {
                    try {
                        w.yaCounter44016539 = new Ya.Metrika({
                            id:44016539,
                            clickmap:true,
                            trackLinks:true,
        ...
        <noscript><div><img src="https://mc.yandex.ru/watch/44016539" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
        <!-- /Yandex.Metrika counter -->
    </body>
</html>
